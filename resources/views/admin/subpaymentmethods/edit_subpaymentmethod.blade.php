...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      ...
      <!-- /.box-header -->
      <!-- form start -->
      <form role="form" action="{{route('subpaymentmethods.update',$paymentmethod->id)}}" method="post">
        @csrf
        <div class="box-body">
        ...
        <div class="box-footer">
          ...
          <a href="{{route('subpaymentmethods.index')}}" class="btn btn-default">{{__('admindash.actions.cancel')}}</a>
        </div>
      </form>
    </div>
    <!-- /.box -->
