        ...
        <div class="box-body">
          ...
          <div class="form-group col-md-12">
            ...
            <select class="form-control" id="product_priority" name="product_priority">
              <option value="1" {{old('product_priority')==1?'selected':''}} {{!old('product_priority') && $product->product_priority==1?'selected':''}}>1</option>
              <option value="2" {{old('product_priority')==2?'selected':''}} {{!old('product_priority') && $product->product_priority==2?'selected':''}}>2</option>
              <option value="3" {{old('product_priority')==3?'selected':''}} {{!old('product_priority') && $product->product_priority==3?'selected':''}}>3</option>
              <option value="4" {{old('product_priority')==4?'selected':''}} {{!old('product_priority') && $product->product_priority==4?'selected':''}}>4</option>
              <option value="5" {{old('product_priority')==5?'selected':''}} {{!old('product_priority') && $product->product_priority==5?'selected':''}}>5</option>
            </select>
          </div>
          <div class="form-group col-md-12">
            <label for="points">{{__('admindash.product.points')}}</label>
            <input type="number" id="points" min="0" step="1" class="form-control" name="reward_points" value="{{old('reward_points')?old('reward_points'):$product->reward_points}}">
          </div>
          <div class="form-group col-md-12">
