...
$(document).ready(function(){
	...
	if ( itemstop.length > max_elem ) {
		$('#top_column #tm_vertical_menu_top .tmvm-menu').append('<li><div class="more-wrap"><span class="more-view">المزيد من المناسبات</span></div></li>');
	}
	...
	$('#top_column #tm_vertical_menu_top .more-wrap').click(function() {
		if ($(this).hasClass('active')) {
			...
			$('.more-wrap').html('<span class="more-view">المزيد من المناسبات</span>');
		} else {
			itemstop.each(function(i) {
				if ( i >= max_elem  ) {
					$(this).slideDown(200);
			...
			$('.more-wrap').html('<span class="more-view">طى القائمة</span>');
		}
	});
	// More Categories
	...
	if ( itemsleft.length > max_elem ) {
		$('#left_column #tm_vertical_menu_top .tmvm-menu').append('<li><div class="more-wrap"><span class="more-view"> المزيد من المناسبات</span></div></li>');
	}
